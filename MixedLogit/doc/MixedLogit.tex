...
\begin{aligned}
	...
	& && = \left[ \textbf{x}^{(1)}_{mj} ,   \textbf{x}^{(2)}_{mj} \times \mathbbm{1}\{r = 1\} , ... ,  \textbf{x}^{(2)}_{mj} \times \mathbbm{1}\{r = R\} \right] \cdot \left[ \beta ; \gamma_1; ... \gamma_R \right]  \\
	& && = \tilde{\textbf{x}}_{mjr} \cdot \tilde{\omega}  \\
\text{where } \hspace*{5pt} & \tilde{\textbf{x}}_{mjr} && = \left[ \textbf{x}^{(1)}_{mj} ,   \textbf{x}^{(2)}_{mj} \times \mathbbm{1}\{r = 1\} , ... ,  \textbf{x}^{(2)}_{mj} \times \mathbbm{1}\{r = R\} \right] \\
\text{and } \hspace*{5pt} & \tilde{\omega} && = \left[ \beta ; \gamma_1; ... \gamma_R \right] \\
\end{aligned}
\end{equation}
...
\begin{equation}
\begin{aligned}
	& V(\textbf{x}_{mj}, \nu_r) && = \textbf{x}_{mj} \cdot \tilde{\beta} + \sum_{l=1}^L \sigma_l \textbf{x}^{(2)}_{mjl} \cdot \nu_{rl} \\
	\text{where } & \tilde{\beta} && = \left[\beta,  \bar{\gamma} \right]'
\end{aligned}
\end{equation}
